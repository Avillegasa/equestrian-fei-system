                    ...
                    <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                      <div>
                        <p className="text-sm text-gray-500">
                          Nuevo usuario registrado: <span className="font-medium text-gray-900">María González</span>
                        </p>
                      </div>
                ...
                <li className="relative pb-8">
                  <div className="relative flex space-x-3">
                    ...
                    <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                      <div>
                        <p className="text-sm text-gray-500">
                          Perfil de juez actualizado: <span className="font-medium text-gray-900">Carlos Mendoza</span>
                        </p>
                      </div>
                      <div className="text-right text-sm whitespace-nowrap text-gray-500">
                        <time>hace 3h</time>
                ...
                <li className="relative">
                  <div className="relative flex space-x-3">
                    ...
                    <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                      <div>
                        <p className="text-sm text-gray-500">
                          Nueva competencia creada: <span className="font-medium text-gray-900">Copa Nacional 2025</span>
                        </p>
                      </div>
                      <div className="text-right text-sm whitespace-nowrap text-gray-500">
                        <time>hace 5h</time>
