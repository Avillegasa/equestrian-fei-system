...
export default function JudgeDashboard({ user }: JudgeDashboardProps) {
  const quickActions = [
    {
      ...
      description: 'Ver competencias asignadas',
      icon: (
    ...
    {
      title: 'Puntuación',
      description: 'Calificar participantes',
      icon: (
    ...
    {
      title: 'Mi Perfil',
      description: 'Actualizar información de juez',
      icon: (
  ...
  return (
    <DashboardLayout user={user} title="Panel de Juez">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-green-600">
                    Tu certificación está vigente y puedes calificar competencias
                  </p>
                </div>
              </div>
            </div>
